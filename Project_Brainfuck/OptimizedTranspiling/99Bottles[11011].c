...
if(idx+2 < 0 || idx+2 > cellCount) {printf("insufficient cell count - multiplier movement 2\n"); return -1;} 
...
if(idx+2 < 0 || idx+2 > cellCount) {printf("insufficient cell count - multiplier movement 2\n"); return -1;} 
cells[idx+2] += 1*cells[idx]; 
if(idx+3 < 0 || idx+3 > cellCount) {printf("insufficient cell count - multiplier movement 3\n"); return -1;} 
