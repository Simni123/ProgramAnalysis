...
if(idx+(8) < 0 || idx+(1) > cellCount) {printf("insufficient cell count - currentArray"); return -1;} 
cells[idx+(8)] = cells[idx+(8)]+(1); 
if(idx+(10) < 0 || idx+(1) > cellCount) {printf("insufficient cell count - currentArray"); return -1;} 
cells[idx+(10)] = cells[idx+(10)]+(1); 
if(idx+(12) < 0 || idx+(1) > cellCount) {printf("insufficient cell count - currentArray"); return -1;} 
cells[idx+(12)] = cells[idx+(12)]+(1); 
idx += (12);
...
if(idx+(0) < 0 || idx+(-1) > cellCount) {printf("insufficient cell count - currentArray"); return -1;} 
cells[idx+(0)] = cells[idx+(0)]+(-1); 
if(idx+(6) < 0 || idx+(1) > cellCount) {printf("insufficient cell count - currentArray"); return -1;} 
cells[idx+(6)] = cells[idx+(6)]+(1); 
/*Ending combined level 2 optimization*/
}
/*Starting combined level 2 optimization*/
idx += (1);
...
/*Starting combined level 2 optimization*/
if(idx+(7) < 0 || idx+(1) > cellCount) {printf("insufficient cell count - currentArray"); return -1;} 
cells[idx+(7)] = cells[idx+(7)]+(1); 
idx += (8);
if(idx > cellCount && idx < 0) {printf("insufficient cellcount"); return -1;}
/*Ending combined level 2 optimization*/
while (cells[idx] != 0) {
...
while (cells[idx] != 0) {
/*Starting combined level 2 optimization*/
if(idx+(5) < 0 || idx+(2) > cellCount) {printf("insufficient cell count - currentArray"); return -1;} 
cells[idx+(5)] = cells[idx+(5)]+(2); 
idx += (6);
if(idx > cellCount && idx < 0) {printf("insufficient cellcount"); return -1;}
/*Ending combined level 2 optimization*/
while (cells[idx] != 0) {
